        ...
        <div className='h-[calc(100vh-127px)] flex  flex-col justify-between w-full p-4 pt-0' >
            <div className='w-full flex flex-col items-center gap-5 mt-[128px]'>
                ...
                <div className='text-gray/800 font-medium text-sm tracking-[-0.21px] p-4 rounded-lg bg-white shadow-[0_4px_20px_0_rgba(19,33,36,0.16),_0_0_2px_0_rgba(19,33,36,0.08)] relative'>
                    ...
                    <p>Hello {userName}! Welcome to this lesson. My name is {currentAvatarName()}, I’ll be your teacher for this lesson.</p>
                </div>
            </div>


            <Button
                text={<p className='flex'>Start lesson! <span className='pl-2'><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
