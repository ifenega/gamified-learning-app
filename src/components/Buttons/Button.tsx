...
const Button = (props: Props) => {
    return (
        ...
        <button
            ...
            className={` rounded-xl py-3 px-2 flex items-center justify-center gap-2 shadow-[0_-3px_0_0_rgba(0,0,0,0.2)_inset] ${props.status ? " bg-teal/300 text-teal/25 " : " bg-teal/500 active:bg-teal/600 disabled:bg-gray/300 disabled:text-gray/500 text-teal/25 "} text-sm font-medium leading-5 w-full`}
